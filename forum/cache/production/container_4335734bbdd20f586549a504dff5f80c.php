...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000017b88751000000002da8a1c0(
...
class phpbbtemplatetwiglexer_0000000017b88751000000002da8a1c0 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5911abd9c1398785082119 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5911abd9c13b6631751202 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5911abd9c1344993093800 = array(
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, 'set_environment', array('env' => $env), $this->initializer5911abd9c13b6631751202);

        return $this->valueHolder5911abd9c1398785082119->set_environment($env);
    }
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5911abd9c13b6631751202);

        return $this->valueHolder5911abd9c1398785082119->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5911abd9c13b6631751202);

        return $this->valueHolder5911abd9c1398785082119->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5911abd9c13b6631751202 = $initializer;
    }
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, '__get', array('name' => $name), $this->initializer5911abd9c13b6631751202);

        if (isset(self::$publicProperties5911abd9c1344993093800[$name])) {
            return $this->valueHolder5911abd9c1398785082119->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5911abd9c1398785082119;
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5911abd9c13b6631751202);
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, '__isset', array('name' => $name), $this->initializer5911abd9c13b6631751202);
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, '__unset', array('name' => $name), $this->initializer5911abd9c13b6631751202);
    ...
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, '__clone', array(), $this->initializer5911abd9c13b6631751202);

        $this->valueHolder5911abd9c1398785082119 = clone $this->valueHolder5911abd9c1398785082119;
    }

    public function __sleep()
    {
        $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, '__sleep', array(), $this->initializer5911abd9c13b6631751202);

        return array('valueHolder5911abd9c1398785082119');
    }
    ...
    {
        return $this->initializer5911abd9c13b6631751202;
    }
    ...
    {
        return $this->initializer5911abd9c13b6631751202 && $this->initializer5911abd9c13b6631751202->__invoke($this->valueHolder5911abd9c1398785082119, $this, 'initializeProxy', array(), $this->initializer5911abd9c13b6631751202);
    }
    ...
    {
        return null !== $this->valueHolder5911abd9c1398785082119;
    }
    ...
    {
        return $this->valueHolder5911abd9c1398785082119;
    }
