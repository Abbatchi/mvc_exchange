...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000004a183ee000000004245bea8(
...
class phpbbtemplatetwiglexer_0000000004a183ee000000004245bea8 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5911abea0df62488919777 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5911abea0df84409386688 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5911abea0defb784650589 = array(
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, 'set_environment', array('env' => $env), $this->initializer5911abea0df84409386688);

        return $this->valueHolder5911abea0df62488919777->set_environment($env);
    }
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5911abea0df84409386688);

        return $this->valueHolder5911abea0df62488919777->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5911abea0df84409386688);

        return $this->valueHolder5911abea0df62488919777->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5911abea0df84409386688 = $initializer;
    }
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, '__get', array('name' => $name), $this->initializer5911abea0df84409386688);

        if (isset(self::$publicProperties5911abea0defb784650589[$name])) {
            return $this->valueHolder5911abea0df62488919777->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5911abea0df62488919777;
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5911abea0df84409386688);
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, '__isset', array('name' => $name), $this->initializer5911abea0df84409386688);
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, '__unset', array('name' => $name), $this->initializer5911abea0df84409386688);
    ...
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, '__clone', array(), $this->initializer5911abea0df84409386688);

        $this->valueHolder5911abea0df62488919777 = clone $this->valueHolder5911abea0df62488919777;
    }

    public function __sleep()
    {
        $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, '__sleep', array(), $this->initializer5911abea0df84409386688);

        return array('valueHolder5911abea0df62488919777');
    }
    ...
    {
        return $this->initializer5911abea0df84409386688;
    }
    ...
    {
        return $this->initializer5911abea0df84409386688 && $this->initializer5911abea0df84409386688->__invoke($this->valueHolder5911abea0df62488919777, $this, 'initializeProxy', array(), $this->initializer5911abea0df84409386688);
    }
    ...
    {
        return null !== $this->valueHolder5911abea0df62488919777;
    }
    ...
    {
        return $this->valueHolder5911abea0df62488919777;
    }
